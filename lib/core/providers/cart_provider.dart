...
class CartProvider extends ChangeNotifier {
  ...
  double         get total     => _items.fold(0.0, (s, i) => s + i.product.price * i.quantity);
 
  void addItem(ProductModel product, {String? customName, String? customNumber}) {
  ...
  Future<bool> submitOrder({
    ...
    try {
      ...
      debugPrint('CartProvider submitOrder error: $e');
      return false;
    }
  }
}